...
// Location: Entire File (Added _regenerateBokehParticles, updated _updateBokehIfNeeded and New Game onPressed callbacks)
...
class _GameScreenState extends State<GameScreen> with TickerProviderStateMixin {
  ...
  void initState() {
      ...
      // Initial particle generation will be triggered by didChangeDependencies -> _updateBokehIfNeeded
  }
  ...
  void _showCompletionDialog(BuildContext context, Duration finalTime) {
      ...
      // Set flag immediately before showing dialog
                  ...
                  actions: <Widget>[
                      TextButton( child: Text('New Game', style: GoogleFonts.nunito(textStyle: dialogTextTheme.labelLarge)),
                          onPressed: () {
                              ...
                              // --- Regenerate bokeh for new game ---
                              _regenerateBokehParticles();
                          }, ),
                      TextButton( child: Text('Close', style: GoogleFonts.nunito(textStyle: dialogTextTheme.labelLarge)),
                        onPressed: () { Navigator.of(dialogContext).pop(); }, ), // Close button ONLY pops
                  ], ); }, );
      // No .then() block needed here to reset flag
  }
  ...
  Widget build(BuildContext context) {
    ...
    // Note: _updateBokehIfNeeded is called in didChangeDependencies now
